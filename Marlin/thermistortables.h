...
#if (THERMISTORHEATER_0 == 21) || (THERMISTORHEATER_1 == 21) || (THERMISTORHEATER_2 == 21) || (THERMISTORBED == 21) //US Sensor GP104L8F
// gen'ed with: python makeTempTable.py --t0=10 --r0=100000 --t1=149 --adc1=317 --t2=248 --adc2=58 --rp=4700
const short temptable_21[][2] PROGMEM = {
    {     213,       300     }, // r=    62 adc=13.32
    {     238,       295     }, // r=    69 adc=14.87
    {     266,       290     }, // r=    78 adc=16.61
    {     297,       285     }, // r=    87 adc=18.55
    {     331,       280     }, // r=    97 adc=20.71
    {     370,       275     }, // r=   109 adc=23.14
    {     413,       270     }, // r=   122 adc=25.84
    {     462,       265     }, // r=   136 adc=28.86
    {     516,       260     }, // r=   153 adc=32.23
    {     576,       255     }, // r=   171 adc=36.00
    {     643,       250     }, // r=   192 adc=40.19
    {     718,       245     }, // r=   216 adc=44.86
    {     801,       240     }, // r=   242 adc=50.07
    {     894,       235     }, // r=   271 adc=55.86
    {     997,       230     }, // r=   305 adc=62.30
    {    1111,       225     }, // r=   342 adc=69.45
    {    1238,       220     }, // r=   385 adc=77.38
    {    1379,       215     }, // r=   432 adc=86.16
    {    1534,       210     }, // r=   486 adc=95.88
    {    1706,       205     }, // r=   547 adc=106.60
    {    1895,       200     }, // r=   615 adc=118.41
    {    2102,       195     }, // r=   693 adc=131.39
    {    2330,       190     }, // r=   780 adc=145.62
    {    2579,       185     }, // r=   879 adc=161.18
    {    2850,       180     }, // r=   991 adc=178.13
    {    3145,       175     }, // r=  1118 adc=196.55
    {    3464,       170     }, // r=  1262 adc=216.48
    {    3807,       165     }, // r=  1425 adc=237.94
    {    4175,       160     }, // r=  1610 adc=260.97
    {    4569,       155     }, // r=  1820 adc=285.53
    {    4986,       150     }, // r=  2059 adc=311.61
    {    5426,       145     }, // r=  2331 adc=339.13
    {    5888,       140     }, // r=  2640 adc=367.98
    {    6369,       135     }, // r=  2994 adc=398.05
    {    6866,       130     }, // r=  3396 adc=429.15
    {    7378,       125     }, // r=  3857 adc=461.10
    {    7899,       120     }, // r=  4383 adc=493.66
    {    8426,       115     }, // r=  4986 adc=526.60
    {    8954,       110     }, // r=  5677 adc=559.65
    {    9481,       105     }, // r=  6470 adc=592.53
    {   10000,       100     }, // r=  7380 adc=624.99
    {   10508,        95     }, // r=  8428 adc=656.77
    {   11002,        90     }, // r=  9636 adc=687.61
    {   11477,        85     }, // r= 11029 adc=717.32
    {   11931,        80     }, // r= 12639 adc=745.70
    {   12362,        75     }, // r= 14502 adc=772.60
    {   12767,        70     }, // r= 16661 adc=797.91
    {   13145,        65     }, // r= 19168 adc=821.55
    {   13496,        60     }, // r= 22083 adc=843.48
    {   13819,        55     }, // r= 25481 adc=863.69
    {   14115,        50     }, // r= 29446 adc=882.19
    {   14385,        45     }, // r= 34085 adc=899.03
    {   14628,        40     }, // r= 39521 adc=914.27
    {   14848,        35     }, // r= 45907 adc=927.99
    {   15044,        30     }, // r= 53423 adc=940.28
    {   15220,        25     }, // r= 62291 adc=951.23
    {   15375,        20     }, // r= 72780 adc=960.94
    {   15512,        15     }, // r= 85216 adc=969.53
    {   15633,        10     }, // r=100000 adc=977.08
    {   15739,         5     }, // r=117624 adc=983.69
    {   15832,         0     }, // r=138693 adc=989.47
};
#endif
